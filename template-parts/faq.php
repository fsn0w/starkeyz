...
<div id="content" class="relative site-content flex flex-grow flex-col bg-no-repeat bg-cover bg-top lg:min-h-screen overflow-y-hidden" style="background-image:url(<?=get_stylesheet_directory_uri()?>/assets/img/faq-bg.jpg);">
    <div class="w-full relative">
            <div class="container mx-auto pt-32 flex justify-center items-center lg:pt-40">
                <h1 class="font-zrnic text-4xl px-5 lg:text-6xl">FAQ's</h1>
                <img src="<?=get_stylesheet_directory_uri()?>/assets/img/faq-main.png" alt="FAQs" class="w-40 lg:w-72" />
            </div>
            ...
            <div class="container mx-auto pb-20">
                ...
                <div class="accordion mt-10">
                    ...
                    <button aria-expanded="false"><span class="accordion-title">What is the Starkeyz?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>Starkeyz is a set of 10,000 unique digital Starkey collectibles living on the Ethereum blockchain (NFTs).<br><br>
Each Starkey has a different combination of traits (different backgrounds, colours, key heads, blades and bitting cuts) - some much rarer than others.<br><br>
The Starkeys collection is divided into 10 rarity-level categories, and each category has its own minting price (ranging from free for the most common ones and up to 1ETH for the rarest category).</p>
                        </div>
                    </div>

                    <div class="accordion-item">
                    <button aria-expanded="false"><span class="accordion-title">What can I do with my Starkeyz?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>Your Starkeyz NFT is like any other NFT and you are free to use it however you choose to under a non-exclusive license.
<br><br>
In the later stages of the project, your unique Starkyz NFT will give you access to a dedicated safe and it will unlock its content.</p>
                        </div>
                    </div>

                    <div class="accordion-item">
                    <button aria-expanded="false"><span class="accordion-title">Where can i find my purchased Starkeyz?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>Like any other NFT, your Starkeyz will appear in the connected wallet/address you used for the purchase.</p>
                        </div>
                    </div>

                    <div class="accordion-item">
                    <button aria-expanded="false"><span class="accordion-title">Who stands behind the Starkeyz project?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>We are a group of visionaries and dreamers that are on a mission to take NFTs to a whole different dimension. From artists to gamers, and from coders to blockchain experts - we have everything it takes to challenge the world as we know it.</p>
                        </div>
                    </div>

                    <div class="accordion-item">
                    <button aria-expanded="false"><span class="accordion-title">What's inside the safe?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>The safe's content will be revealed at a later stage, and only once more than 90% of the keys are minted.</p>
                        </div>
                    </div>

                    <div class="accordion-item">
                    <button aria-expanded="false"><span class="accordion-title">How many Starkeyz can I mint at the same time?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p>There's a mint limit of 5 Starkeyz.</p>
                        </div>
                    </div>

                    <div class="accordion-item">
                    <button aria-expanded="false"><span class="accordion-title">Where can I interact with & meet other community members?</span><span class="icon" aria-hidden="true"></span></button>
                        <div class="accordion-content">
                            <p class="footer-social">

            <span class="inline-block text-center"><a href="https://twitter.com/StarKeyz_" target="_blank" class="inline-flex justify-center items-center w-16 h-16 mx-4 mb-3 rounded-full"><svg width="24" height="19" viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			</svg></a> <br> twitter </span>

			<span class="inline-block text-center"><a href="https://t.me/joinchat/v8BQPybRwcM4ZDM9" target="_blank" class="inline-flex justify-center items-center w-16 h-16 mx-4 mb-3 rounded-full"><svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<span class="inline-block text-center"><a href="https://discord.gg/BqSNp2ZAKP" target="_blank" class="inline-flex justify-center items-center w-16 h-16 mx-4 mb-3 rounded-full"><svg width="28" height="21" viewBox="0 0 28 21" fill="none" xmlns="http://www.w3.org/2000/svg">
